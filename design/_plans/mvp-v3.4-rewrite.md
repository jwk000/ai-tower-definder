...
| W2.4 | 实现 AttackSystem + ProjectileSystem | 绿 | `src/systems/AttackSystem.ts`、`src/systems/ProjectileSystem.ts` | `refactor(roguelike): implement attack and projectile resolution` |
