...
> 版本: v3.0 | 日期: 2026-05-12 | 卡牌 + Roguelike 长征版
...
- **核心变更**：
  ...
  - 单局 Run = 8 关连闯 + 终战 Boss，大本营 HP 全程继承
  - 关间二选一节点：商店或秘境
...
| 03 | [单位配置数据](./03-unit-data.md) | 🔶 v3.0 §8-§10 追加 | 单位属性、卡牌目录（30 张开服卡）、13 个新敌人 |
| 04 | [技能与Buff系统](./04-skill-buff-system.md) | 🔶 v3.0 §5 追加 | 技能/Buff 系统、法术卡子分类 |
...
| 13 | [存档系统](./13-save-system.md) | ✅ v3.0 全文重写 | 存档 v2.0.0、CardCollection、OngoingRun、v1.1→v2.0 迁移 |
...
| 19 | [导弹塔设计](./19-missile-tower.md) | 沿用 | 战略武器、全图射程、地格评分、大范围爆炸 |
| 20 | [响应式布局](./20-responsive-layout.md) | 🔶 v3.0 §4.5 追加 | 锚点定位系统、v3.0 手牌区+关间+商店+秘境+卡池 9 类锚点 |
| 21 | [MDA数值设计](./21-mda-numerical-design.md) | 🔶 v3.0 §12-§18 追加 | 数值真理源、新增能量表/商品价/难度乘数/卡解锁价/碎片价 |
...
6. **Run 长征** — 8 关连闯 + 终战，大本营 HP 全程继承，死亡从第 1 关重开
