...
> 根据 [25-card-roguelike-refactor](./25-card-roguelike-refactor.md) 方案，本节定义卡牌系统的视觉规范。所有卡牌图形采用**纯几何 + PixiJS WebGL** 绘制，**禁用任何外部图片资源**。
>
...
> v3.0 新增。配套逻辑见 [25 §6.2 水晶机制](./25-card-roguelike-refactor.md#62-水晶机制核心防御实体)；数值见 [21 §19](./21-mda-numerical-design.md#19-水晶机制数值v30-新增--大本营--水晶)；动效粒子见 [12 §10](./12-visual-effects.md#10-水晶视觉与特效v30-新增)。
...
| **音效联动** | — | 见 [10-audio §15](./10-audio-system.md) 新增 `crystal_shatter` 音效（玻璃碎裂 + 低频轰鸣） |
...
参考 [07 §6 主题配色表](./07-map-level-system.md)：
